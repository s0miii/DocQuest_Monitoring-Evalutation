...
router.register(r'accomplishment_reports', AccomplishmentReportViewSet, basename='accomplishment-report' )
...
urlpatterns = [
    ...
    path('generate_evaluation_link/', GenerateEvaluationSharableLinkView.as_view(), name='generate_evaluation_link'),
