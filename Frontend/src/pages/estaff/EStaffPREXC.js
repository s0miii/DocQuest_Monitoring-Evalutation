...
const EStaffPREXC = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            await axios.post(`${API_URL}/monitoring/college_performance/`, dataToSave, {
                headers: {
                            ...
                            <table class="border border-gray-300 text-sm text-center table-auto">
                                ...
                                <thead>
                                    ...
                                    <tr className="text-gray-800 bg-gray-200">
                                        <th colSpan="15" className="px-4 py-2 text-center">
                                            SUMMARY OF ACCOMPLISHMENT AS OF{" "}
                                            <input
                                                type="text"
                                                value={month}
                                                onChange={(e) => setMonth(e.target.value)}
                                                className="px-2 py-1 border border-gray-300 rounded w-[80px] text-center"
                                                placeholder="Month"
                                            />{" "}
                                            <input
                                                type="text"
